...
def through_sections():
    # ruled
    circle_1 = gp_Circ(gp_Ax2(gp_Pnt(-100.0, 0.0, -100.0), gp_Dir(0.0, 0.0, 1.0)), 40.0)
    wire_1 = BRepBuilderAPI_MakeWire(BRepBuilderAPI_MakeEdge(circle_1).Edge()).Wire()
    circle_2 = gp_Circ(gp_Ax2(gp_Pnt(-10.0, 0.0, -0.0), gp_Dir(0.0, 0.0, 1.0)), 40.0)
    wire_2 = BRepBuilderAPI_MakeWire(BRepBuilderAPI_MakeEdge(circle_2).Edge()).Wire()
    circle_3 = gp_Circ(gp_Ax2(gp_Pnt(-75.0, 0.0, 100.0), gp_Dir(0.0, 0.0, 1.0)), 40.0)
    wire_3 = BRepBuilderAPI_MakeWire(BRepBuilderAPI_MakeEdge(circle_3).Edge()).Wire()
    circle_4 = gp_Circ(gp_Ax2(gp_Pnt(0.0, 0.0, 200.0), gp_Dir(0.0, 0.0, 1.0)), 40.0)
    ...
    # smooth
    circle_1b = gp_Circ(gp_Ax2(gp_Pnt(100.0, 0.0, -100.0), gp_Dir(0.0, 0.0, 1.0)), 40.0)
    wire_1b = BRepBuilderAPI_MakeWire(BRepBuilderAPI_MakeEdge(circle_1b).Edge()).Wire()
    circle_2b = gp_Circ(gp_Ax2(gp_Pnt(210.0, 0.0, -0.0), gp_Dir(0.0, 0.0, 1.0)), 40.0)
    wire_2b = BRepBuilderAPI_MakeWire(BRepBuilderAPI_MakeEdge(circle_2b).Edge()).Wire()
    circle_3b = gp_Circ(gp_Ax2(gp_Pnt(275.0, 0.0, 100.0), gp_Dir(0.0, 0.0, 1.0)), 40.0)
    wire_3b = BRepBuilderAPI_MakeWire(BRepBuilderAPI_MakeEdge(circle_3b).Edge()).Wire()
    circle_4b = gp_Circ(gp_Ax2(gp_Pnt(200.0, 0.0, 200.0), gp_Dir(0.0, 0.0, 1.0)), 40.0)
